...
✅ ОБЯЗАТЕЛЬНО:
• Конкретные шаги: "Открой X, сделай Y"
• 2-3 альтернативы с плюсами/минусами
...
ПЛОХО: "Попробуй разбить"
ХОРОШО: "Судя по навыкам в дизайне, начни с макета. 2 подхода: 1) Быстрый за 2ч, 2) Детальный за день. Что выберешь?"
