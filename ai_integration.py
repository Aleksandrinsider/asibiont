...
ДЕЛЕГИРОВАНИЕ ЗАДАЧ:
- ЕСЛИ В СООБЩЕНИИ ЕСТЬ @username - ЭТО ВСЕГДА ДЕЛЕГИРОВАНИЕ, даже если используется слово "напомни"!
- Примеры делегирования: "напомни @username сделать отчет", "@alex подготовь презентацию к пятнице", "попроси @mike проверить код"
