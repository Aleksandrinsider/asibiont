...
❌ НУМЕРОВАННЫЕ СПИСКИ (1. 2. 3. или цифры в начале строк) - ПОЛНОСТЬЮ ЗАПРЕЩЕНЫ!
❌ Структурированные списки с цифрами типа: "1. Вариант А" или "2. Что сделать"

✅ ВМЕСТО ЭТОГО: Пиши текстом через запятые, союзы "или", "либо", "также", абзацы. Как в живой переписке!
