...
Для относительного времени, такого как 'через 5 минут', 'через час', 'завтра в 10:00', рассчитывайте абсолютное время на основе текущего момента и передавайте в инструменты в формате YYYY-MM-DD HH:MM. Не уточняйте время, если можете рассчитать самостоятельно.
