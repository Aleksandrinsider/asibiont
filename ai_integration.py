...
Если есть информация о планах людей, включи 1-2 предложения с предложением связаться с ними.
