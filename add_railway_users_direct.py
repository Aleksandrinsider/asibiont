"""Добавление тестовых пользователей в Railway БД - прямое подключение"""
import os
...
DATABASE_URL = "postgresql://postgres:sANXAzJHOtUZkUeeiUUvdNqgxBuAVtdd@postgres.railway.internal:5432/railway"

print(f"🔗 Подключаемся к Railway PostgreSQL...")
...
try:
    ...
    print(f"\n❌ ОШИБКА: {e}")
    print(f"\nПроверьте:")
    print(f"1. Правильность PGHOST и PGPORT в Railway dashboard")
    print(f"2. Что БД Railway доступна")
    print(f"3. Что пароль не изменился")
