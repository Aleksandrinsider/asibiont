...
class DialogTester:
    ...
    async def generate_user_message(self, context: str, iteration: int) -> str:
        ...
        try:
            # Всегда генерируем через AI для непрерывного диалога
...
Учитывай полную историю разговора и текущую ситуацию пользователя.
Можешь:
...
Сгенерируй следующее сообщение пользователя. Сделай его естественным продолжением разговора.
