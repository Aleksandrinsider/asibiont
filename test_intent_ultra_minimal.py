#!/usr/bin/env python3
"""
Test script for ultra minimal intent classification with real user queries
"""
import asyncio
import sys
import os
...
async def test_ultra_minimal_intent_classification():
    """Test ultra minimal intent classification on real user queries"""
    ...
    print("Testing ULTRA MINIMAL intent classification (AI figures everything out)...")
    print("=" * 70)
    ...
    for query, expected_intent in test_queries:
        try:
            result = await IntentClassifierUltraMinimal.classify_intent(query, user_id=123)
...
if __name__ == "__main__":
    asyncio.run(test_ultra_minimal_intent_classification())