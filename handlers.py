...
PREMIUM_DESCRIPTION = """🎯 Закрытое сообщество от ASI лаборатории искусственного интеллекта ASI Biont с живым поиском единомышленников через ваши текущие дела: система анализирует задачи и цели, находя партнеров в вашем городе. AI-агент запоминает контекст вашей жизни, связывает задачи, понимает голосовые сообщения и предлагает умные шаги с напоминаниями. Панель управления объединяет всё: задачи, партнеры, встречи, историю взаимодействий и статистику.
