...
PREMIUM_DESCRIPTION = """🎯 Лаборатория искусственного интеллекта ASI Biont — закрытое сообщество для тех, кто создаёт будущее. Здесь нет места скучным знакомствам — только те, кто идёт в том же направлении.

Забудьте про мёртвые контакты и случайные связи. В ASI Biont вас окружают единомышленники, с которыми можно запустить крутой проект, достичь целей или просто весело провести время.
