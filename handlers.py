...
PREMIUM_DESCRIPTION = """🎯 ASI Biont — эксклюзивное сообщество для роста и достижений

Закрытое пространство для тех, кто движется вперёд. Здесь нет случайных людей — только те, кто ставит цели и достигает их. Программисты, предприниматели, творцы, спортсмены — все работают над реальными проектами и помогают друг другу расти.

**3000₽/месяц** — вход в сообщество + инструменты

**Сообщество единомышленников**
Находите партнёров по интересам и целям в вашем городе. Система автоматически подбирает людей для проектов, бизнеса, хобби. Делегируйте задачи, работайте вместе, отслеживайте прогресс команды.

**AI-агент для продуктивности**
Управление через диалог — "напомни через час", "что у меня сегодня". Автоматическое планирование, умные напоминания с контекстом, анализ задач и целей. Работает с файлами.

**Веб-панель для контроля**
Все задачи, контакты, дедлайны в одном месте. Фильтры, статистика, история взаимодействий.

**Безопасность**
End-to-end шифрование. Ваши данные видите только вы.

Станьте частью эксклюзивного сообщества — /subscribe

Вопросы: @aleksandrinsider"""
