...
PREMIUM_DESCRIPTION = """🎯 ASI Biont — эксклюзивное сообщество для роста

Закрытое пространство для тех, кто движется вперёд. Здесь нет случайных людей — только те, кто ставит цели и достигает их. Программисты, предприниматели, творцы — все работают над реальными проектами и помогают друг другу расти.

3000₽/месяц — вход в сообщество + инструменты

✓ Сообщество единомышленников
Находите партнёров по интересам в вашем городе за минуты. Система автоматически подбирает людей для проектов, бизнеса, хобби. Делегируйте задачи, работайте вместе, отслеживайте прогресс команды. Никакого одиночества — только совместный рост.

✓ AI-агент, который понимает вас
Управление через диалог — "напомни через час про звонок Максиму", "что у меня сегодня", "добавь встречу с командой на завтра". Автоматическое планирование, умные напоминания с полным контекстом задачи. Анализирует ваши цели и предлагает следующие шаги. Работает с файлами — прикрепите документ для обработки.

✓ Веб-панель для полного контроля
Все задачи, контакты партнёров, дедлайны в одном месте. Мощные фильтры, детальная статистика, история всех взаимодействий. Видите весь прогресс команды в реальном времени.

✓ Безопасность данных
End-to-end шифрование. Ваши данные, задачи и переписки видите только вы. Полная конфиденциальность.
