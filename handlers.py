...
PREMIUM_DESCRIPTION = """👥 ASI Biont — сообщество, которое движет вверх

Нужен партнёр для стартапа? Забываете о важных встречах? Хотите найти единомышленников? ASI Biont решает главные проблемы современного человека: одиночество в целях, хаос в задачах, отсутствие нужных контактов.

3000₽/месяц — доступ к сообществу и AI-агенту:

🔍 Находите своих людей
Программисты, предприниматели, спортсмены, творцы — укажите интересы, и система найдёт людей с похожими целями в вашем городе. Для проектов, хобби, бизнеса, дружбы.

🤝 Растите вместе
Делегируйте задачи, работайте над общими проектами, отслеживайте прогресс друг друга. Сообщество, где помогают достигать целей.

⚡️ Управляйте жизнью через диалог
"Напомни через час про встречу" — AI создаст задачу. "Что у меня сегодня?" — покажет план. Никаких форм, только разговор. Умные напоминания с полным контекстом.

🧠 Агент понимает цели
Анализирует ваши задачи, предлагает следующие шаги, находит связи между проектами. Работает с файлами — прикрепите документ для анализа.

📊 Веб-панель для контроля
Все задачи, контакты, дедлайны в одном месте. Фильтры, статистика, история взаимодействий.

🔒 Полное шифрование
Ваши данные видите только вы. End-to-end шифрование всего.

Перестаньте работать в одиночку — /subscribe
