...
PREMIUM_DESCRIPTION = """🤖 ASI Biont — AI-агент, который закрывает ваши реальные потребности

Забываете о важных задачах? Не успеваете всё запланировать? Нужны люди для совместной работы? ASI Biont решает эти проблемы через интеллектуального ассистента и сообщество единомышленников.

Что вы получаете за 3000₽/месяц:

💬 Управление задачами через диалог
Просто говорите что нужно сделать — агент сам создаст задачу, поставит напоминание, определит приоритет. Спросите "что у меня на сегодня" — получите список дел с контекстом.

⏰ Умные напоминания и контекст
Агент не просто напомнит о задаче, а объяснит зачем она нужна, что сделать, какие есть зависимости. Учитывает ваш часовой пояс и рабочее время.

🎯 Автоматическое планирование
Скажите "через час нужно сделать отчёт" — агент создаст задачу на точное время. Можете планировать задачи на дни, недели вперёд естественным языком.

🧠 Проактивный ассистент
Анализирует ваши задачи и профиль, предлагает следующие шаги, находит связи между задачами, помогает расставить приоритеты. Работает с прикреплёнными файлами для анализа.

👥 Поиск единомышленников
Укажите интересы и навыки — агент найдёт людей с похожими целями в вашем городе. Для программистов, дизайнеров, спортсменов, предпринимателей — для любой сферы.

🤝 Делегирование задач
Назначайте задачи коллегам, принимайте задания от других, отслеживайте прогресс. Удобно для команд и совместных проектов.

📊 Веб-панель для управления
Полная картина задач с фильтрами, приоритетами, дедлайнами. История взаимодействий, статистика, поиск людей — всё в одном месте.

🔒 Шифрование данных
End-to-end шифрование всех данных. Даже мы не видим содержимое ваших задач и переписки.

Решите свои задачи эффективнее — оформите подписку командой /subscribe
