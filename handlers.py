...
PREMIUM_DESCRIPTION = """🎯 Сеть нового поколения от лаборатории искусственного интеллекта ASI Biont - инновационная платформа для поиска единомышленников через ваши дела. Система анализирует текущие задачи и цели, автоматически находя людей в городе. Самостоятельно ищет самые релевантные контакты, обеспечивая мгновенное подключение к нужным людям.
