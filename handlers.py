...
async def subscribe_handler(message: Message):
    ...
    await message.bot.send_message(message.chat.id, f"Оплатить с помощью ЮКАССА, СБЕР или БАНКОВСКОЙ КАРТЫ: {payment_url}\n\n🚀 **Премиум-подписка на EREBUS AI Task Bot**\n\nС подпиской вы получите:\n- Умные проактивные сообщения с анализом вашей ситуации и мотивацией\n- Персонализированные напоминания и советы по задачам\n- Доступ к сообществу единомышленников для поиска партнеров\n- Аналитика прогресса и рекомендаций для повышения продуктивности\n\nПосле оплаты подписка активируется мгновенно! Добро пожаловать в мир эффективного управления задачами с ИИ! 💪")
    session.close()
