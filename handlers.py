...
Управление через диалог — "напомни через час про звонок Максиму", "что у меня сегодня", "добавь встречу с командой на завтра в 15:00". Автоматическое планирование, умные напоминания с полным контекстом. Анализирует ваши цели и предлагает следующие шаги. Работает с файлами — прикрепите документ для обработки.
