...
PREMIUM_DESCRIPTION = """🚀 ASI Biont — ваш умный помощник в мире задач и связей!

Получите полный доступ к революционной системе управления задачами с ИИ:

🤖 **Интеллектуальный AI-ассистент:**
• Натуральный разговорный интерфейс для управления задачами
• Автоматическое создание задач из ваших идей
• Умные напоминания и приоритезация
• Персонализированные советы по продуктивности

👥 **Сообщество единомышленников:**
• Поиск партнеров по интересам и навыкам
• Делегирование задач коллегам
• Совместная работа над проектами
• Рекомендации по коллаборациям

📊 **Продвинутые инструменты:**
• Веб-панель для удобного управления
• Аналитика прогресса и статистика
• Персональные отчеты о достижениях
• Интеграция с календарем и временем
...
Стоимость: всего 3000 ₽ в месяц!

Оформите подписку командой /subscribe и откройте новый уровень продуктивности! 💪✨"""
