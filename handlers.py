...
Пока вы занимаетесь главным — он растит вашу сеть, постит контент, делегирует задачи и ловит возможности.

✨ Что он делает:
• «Завтра в 9 созвон» — помнит и напомнит
• «Ищу дизайнера» — найдёт @anna и представит
• «Кому передать задачу?» — найдёт исполнителя и передаст
• Вы спите — он постит в канал (Премиум)
...
LIGHT — 3000₽/месяц
«Ищу маркетолога» — AI ищет в сети по целям и навыкам. Вы растёте. AI находит.

STANDARD — 9000₽/месяц (ПОПУЛЯРНЫЙ)
Всё из Light + делегирование. «Кому передать статью?» — AI находит @maria, передаёт задачу, следит за дедлайном.

PREMIUM — 27000₽/месяц
Всё из Standard + автопилот. Вы спите — он постит каждые 6 часов. Вы на встрече — он делегирует. AI никогда не спит.
