...
async def csp_middleware(request, handler):
    response = await handler(request)
    response.headers['Content-Security-Policy'] = "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://telegram.org https://fonts.googleapis.com https://mc.yandex.ru https://mc.yandex.com https://yastatic.net https://*.yastatic.net https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://api.deepseek.com https://mc.yandex.ru https://mc.yandex.com https://*.yandex.ru https://*.yandex.com https://*.webvisor.org wss://mc.yandex.ru wss://mc.yandex.com wss://*.yandex.ru wss://*.yandex.com wss://*.webvisor.org; frame-src https://oauth.telegram.org https://mc.yandex.ru https://mc.yandex.com https://*.yandex.ru https://*.webvisor.org; child-src 'self' blob: https://mc.yandex.ru https://mc.yandex.com https://*.yandex.ru https://*.webvisor.org; worker-src 'self' blob:;"
