...
class User(Base):
    ...
    tg_avatar_data = Column(Text)  # Cached Telegram avatar bytes (base64 data URI), refreshed in background
...
class UserAgent(Base):
    ...
    gender = Column(String(10), default='male')        # male/female — для правильного рода в ответах
