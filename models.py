...
engine = create_engine(
    db_url,
    pool_size=5,  # 5 permanent connections for browser + background tasks
    max_overflow=5,  # 5 additional overflow connections (max 10 total)
    pool_timeout=15,  # 15 second timeout before giving up
