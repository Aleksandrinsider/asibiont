#!/usr/bin/env python3
"""
Test script for intent classification with real user queries
"""
import asyncio
import sys
import os
...
from ai_integration.intent_classifier import IntentClassifier

async def test_intent_classification():
    """Test intent classification on real user queries"""
    ...
    print("Testing intent classification with real queries...")
    print("=" * 60)
    ...
    for query, expected_intent in test_queries:
        try:
            result = await IntentClassifier.classify_intent(query, user_id=123)
