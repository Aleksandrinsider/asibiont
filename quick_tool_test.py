...
async def test_key_tools():
    """Тест ключевых инструментов на реальных запросах"""

    print("🔧 ТЕСТ КЛЮЧЕВЫХ ИНСТРУМЕНТОВ\n")
    ...
    # Тестовые сценарии для ключевых инструментов
    test_scenarios = [
        ...
        # 5. Показ профиля - должен вызывать show_profile
        {
