...
Проанализируй ответ AI и ОТВЕТЬ ЛОГИЧНО:

- Если AI спросил про город/работу/имя → ответь конкретно: "Москва", "Работаю в Яндекс", "Меня зовут Алекс"
- Если AI предложил помощь/спросил "Чем помочь?" → дай команду: "Добавь задачу позвонить клиенту завтра в 14:00"
- Если AI показал пустой список → добавь задачу: "Добавь встречу с партнёром послезавтра в 11:00"
- Если AI показал задачи → попроси действие: "Делегируй @testuser первую задачу" или "Покажи задачи на завтра"
- Если AI добавил задачу → либо "Покажи список", либо добавь ещё одну задачу
- Если AI удалил/завершил задачу → "Что осталось?" или добавь новую
- Если AI спросил про профиль → ответь на вопрос или скажи "Сначала покажи задачи"

Правила:
- КОРОТКИЙ ответ (3-10 слов)
- Если вопрос → дай прямой ответ
- Если предложение → дай команду
- Варьируй: добавь, удали, делегируй @testuser, покажи, расскажи о себе
- Времена: "через час", "завтра в 15:00", "в пятницу"
- Только текст, БЕЗ кавычек
