                ...
                if anchor.anchor_type == 'goal_autopilot_review' and _chosen_id != 0:
                    ...
                    try:
                        ...
                        _coord_prompt = (
                            ...
                            + f"\nНапиши 2-3 предложения как живой коллега в рабочем чате. Обратись по имени.\n"
                            "Будь конкретным: не 'займись целями', а 'проверь ответы в почте' или 'найди 3 контакта'\n"
                            "Объясни почему именно этот подход и что ждёшь в итоге — всё в одном потоке, без заголовков и нумерации.\n"
                            "Предлагай только подключённые каналы из списка выше.\n"
