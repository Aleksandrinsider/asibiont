            ...
            if _results_for_report:
                try:
                    ...
                    _report_prompt = (
                        ...
                        f"- ОБЯЗАТЕЛЬНО называй агентов по именам как живых людей: 'Кристина проверила почту и нашла ответ от...', "
                        f"'Марк нашёл 3 контакта на GitHub'. НЕ 'команда работала' или 'агент выполнил'.\n"
