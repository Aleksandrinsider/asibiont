            ...
            if anchor.anchor_type == 'email_outreach_send':
                ...
                for d_obj in live_drafts:
                    ...
                    compose_prompt = (
                        ...
                        f"- Body: plain text, 3-5 SHORT sentences, max 100 words total\n"
                        f"- PERSONALIZATION IS MANDATORY: mention a SPECIFIC detail about the recipient "
                        f"(their project name, technology they use, article they wrote, product they built). "
                        f"'I noticed your work in [broad field]' is NOT personalization. "
                        f"'Saw your [specific project/article/tool name]' IS personalization.\n"
                        f"- First email = simple question, NOT a pitch. Ask if the topic is relevant, don't sell.\n"
                        ...
                        f"- Write like a HUMAN colleague, not a marketing bot. Casual, brief, genuine.\n"
                        f"- End with ONE simple question (yes/no answerable)\n"
