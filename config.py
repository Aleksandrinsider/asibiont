...
API_TIMEOUT_NORMAL = int(os.getenv("API_TIMEOUT_NORMAL", "30"))   # Standard AI calls
API_TIMEOUT_LONG = int(os.getenv("API_TIMEOUT_LONG", "45"))       # Research, delegation, complex tasks
