...
_SERVICE_LABELS = {
    ...
    'resend':    'Email-сервис (legacy Resend)',
...
_RECOVERY_HINTS = {
    ...
    'resend': (
        'Legacy email-сервис (Resend) вернул ошибку. '
        'Для исходящих писем агентов используется только Gmail OAuth, '
        'поэтому проверь подключение Gmail в профиле пользователя. '
        'Resend может использоваться в отдельных системных/исторических сценариях.'
    ),
    'openweathermap': (
