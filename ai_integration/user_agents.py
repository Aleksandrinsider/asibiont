...
"""
    ...
    overlay += """
ФОРМАТ ОТВЕТОВ В ЧАТ (обязательно):
Пиши сплошным текстом как в мессенджере, 2-4 абзаца. Абзацы разделяй одной пустой строкой (не двумя и более).
ЗАПРЕЩЕНО: заголовки (## / # / ###), жирный (**текст**), маркированные списки (—, •, *), нумерованные списки (1. 2.), блоки кода.
Отчёты о выполненных задачах — коротко: что сделал, результат, следующий шаг. Без лишних разделов и структур.
"""
