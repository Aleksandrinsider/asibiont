...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "add_task",
            "description": "Создать НОВУЮ задачу. Если пользователь ЯВНО просит создать задачу или напоминание (напомни, поставь задачу, создай задачу, запланируй) И указал время — СРАЗУ создавай add_task БЕЗ переспрашивания. Если время НЕ указано — СПРОСИ. Для ИЗМЕНЕНИЯ существующей задачи — ВСЕГДА edit_task, НЕ add_task.",
            "parameters": {
                "type": "object",
                "properties": {
                    "title": {
