...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "delegate_task",
            "description": "Делегировать задачу другому пользователю ИЛИ агенту из команды пользователя. Используй когда видишь 'делегируй', 'поручи', 'передай', 'попроси агента'. Имена доступных агентов смотри в блоке КОМАНДА АГЕНТОВ в контексте.",
            "parameters": {
                "type": "object",
                "properties": {
                    "title": {
