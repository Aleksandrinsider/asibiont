...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "create_post",
            "description": "📝 Создать пост в блог платформы (не TG-канал). Публикуй только после явного согласия пользователя. ВСЕГДА добавляй image_url с картинкой с Unsplash по теме поста.",
            "parameters": {
                "type": "object",
                "properties": {
                    "content": {
