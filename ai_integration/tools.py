...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "save_user_rule",
            "description": "Сохранить поведенческое правило или предпочтение пользователя в долгосрочную память. Вызывай когда пользователь явно инструктирует тебя или агентов как действовать в будущем (например: 'не пиши X', 'всегда делай Y', 'при задаче Z — используй W'). НЕ вызывай для обычных просьб — только для долгосрочных инструкций.",
            "parameters": {
                "type": "object",
                "properties": {
                    "rule": {
