...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "create_post",
            "description": "📝 Опубликовать пост в блог платформы (не TG-канал). Вызывай когда пользователь просит опубликовать, написать пост, запостить. Если пользователь просит ТОЛЬКО черновик/текст БЕЗ публикации — покажи текст в чате. ВСЕГДА добавляй image_url с картинкой с Unsplash по теме поста.",
            "parameters": {
                "type": "object",
                "properties": {
                    "content": {
