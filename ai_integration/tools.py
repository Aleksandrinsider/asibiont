...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "generate_image",
            "description": "🎨 Сгенерировать изображение в нарисованном/иллюстративном стиле (Flux). Ключевые слова: нарисуй, создай изображение, сгенерируй картинку. Стиль всегда: hand-drawn illustration. Пиши промпт на английском. ВАЖНО: НЕ отправляй результат в Telegram сам — используй URL из результата как image_url для create_post или publish_to_telegram.",
            "parameters": {
                "type": "object",
                "properties": {
                    "prompt": {
