...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "🎯 Находит актуальные мероприятия в городе пользователя: митапы, концерты, выставки, бизнес-события. Используй когда пользователь упоминает досуг, нетворкинг, куда пойти, что делать в городе. Автоматически учитывает город из профиля. Примеры: 'куда сходить', 'какие митапы', 'где познакомиться с людьми', 'интересные события'.",
            "parameters": {
                "type": "object",
                "properties": {
                    "categories": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Категории мероприятий: 'митапы', 'бизнес', 'концерты', 'выставки', 'спорт', 'образование', 'вечеринки'. Можно несколько.",
                    },
                    "days_ahead": {
                        "type": "integer",
                        "description": "На сколько дней вперёд искать (default: 7)",
                        "default": 7
                    },
                    "price_range": {
                        "type": "string",
                        "enum": ["free", "paid", "all"],
                        "description": "Фильтр по цене: 'free' - бесплатные, 'paid' - платные, 'all' - все (default)",
                        "default": "all"
                    },
                    "limit": {
                        "type": "integer",
                        "description": "Максимум событий (default: 5)",
                        "default": 5
                    }
                },
                "required": [],
