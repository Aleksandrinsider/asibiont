        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "post_time": {
                        "type": "string",
                        "description": "Время публикации (HH:MM). Если пользователь указал время — используй его. Если нет — предложи 10:00 (утро) или 18:00 (вечер) в зависимости от аудитории."
                    },
                    "max_posts": {
                        "type": "integer",
