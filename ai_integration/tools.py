...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "delegate_task",
            "description": "Поручить задачу агенту из команды пользователя ИЛИ другому пользователю. Используй по смыслу — когда ситуация требует действия от агента или другого человека: анализ, поиск, отправка писем, мониторинг, любое задание. Не жди специальных слов — оцени контекст. Имена доступных агентов смотри в блоке КОМАНДА АГЕНТОВ в контексте. Когда поручаешь АГЕНТУ — дедлайн не обязателен, агент приступит сразу.",
            "parameters": {
                "type": "object",
                "properties": {
                    "title": {
