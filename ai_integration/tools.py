        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "post_time": {
                        "type": "string",
                        "description": "Время публикации (HH:MM). Если пользователь указал — используй. Если нет — можно не передавать, система подберёт свободный слот из расписания пользователя."
                    },
                    "max_posts": {
                        "type": "integer",
