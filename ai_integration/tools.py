        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "description": {
                        "type": "string",
                        "description": "⚠️ ТОЛЬКО слова пользователя из диалога! НЕ додумывай детали, НЕ расширяй описание. Если пользователь сказал кратко - передай кратко. Примеры: 'надо запустить маркетинг' → description='запустить маркетинг', 'встретиться с командой обсудить проект' → description='обсудить проект'. ПУСТО если пользователь не дал деталей.",
                    },
                    "reminder_time": {
                        "type": "string",
