        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "reply_body": {
                        "type": "string",
                        "description": "Текст ответа — в рамках цели кампании, вежливый, с продвижением к следующему шагу. ⚠ КРИТИЧНО: reply_body ДОЛЖЕН быть на ТОМ ЖЕ ЯЗЫКЕ что и оригинальное outreach-письмо! Если оригинал на EN — ответ на EN. Если на RU — на RU. Если check_emails показал ⚠ ПРЕДПОЧТЕНИЯ КОНТАКТОВ — пиши на указанном языке. Несовпадение языка = БЛОКИРОВКА отправки."
                    }
                },
                "required": ["reply_body"]
            }
