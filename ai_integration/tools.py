...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "research_topic",
            "description": "🔍 ВЕБ-ПОИСК И АНАЛИЗ (STANDARD+): AI исследует тему через Google Search, анализирует найденную информацию и дает практические рекомендации. Идеально для: изучения рынка, анализа конкурентов, поиска трендов, исследования ниши. Примеры: 'изучи рынок AI-ботов', 'проанализируй конкурентов в нише X', 'какие тренды в маркетинге 2026'. Доступно с STANDARD или PREMIUM.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "📰 НОВОСТИ И ТРЕНДЫ по интересам (STANDARD+): AI ищет актуальные новости по теме пользователя и анализирует тренды. Идеально для: отслеживания изменений в индустрии, мониторинга конкурентов, поиска бизнес-возможностей. Примеры: 'новости в сфере AI', 'тренды в стартапах', 'что происходит в моей индустрии'. Доступно с STANDARD или PREMIUM.",
            "parameters": {
                "type": "object",
                "properties": {
                    "topic": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "🔍 БЫСТРЫЙ ПОИСК ПО ТЕМЕ (LIGHT+): Простой поиск без AI анализа - топ-3 результата с ссылками на источники. Помогает быстро найти основную информацию и проверить актуальность темы. Примеры: 'найди информацию о Python', 'что сейчас с криптовалютами', 'поищи про стартапы в ИИ'. Доступно всем пользователям.",
            "parameters": {
                "type": "object",
                "properties": {
                    "topic": {
                        "type": "string",
                        "description": "Тема для быстрого поиска. Примеры: 'Python разработка', 'искусственный интеллект 2026', 'стартапы в России'"
                    }
                },
                "required": ["topic"]
            }
