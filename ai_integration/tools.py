...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "delete_task",
            "description": "Удалить задачу. Ключевые слова: 'удали', 'убери', 'сотри'. НЕ используй для завершения (используй complete_task).",
            "parameters": {
                "type": "object",
                "properties": {
                    "task_title": {
    ...
    },
    {
        ...
        "function": {
            "name": "research_topic",
            "description": "🔍 Исследование темы через Google Search + AI-анализ. Вызывай при любом вопросе о теме/рынке/технологии.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
