        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "description": {
                        "type": "string",
                        "description": "Детали задачи (до 500 символов). Включи ВСЮ важную информацию из запроса — структуру, пункты, ключевые моменты. НЕ обрезай и НЕ сокращай то что сказал пользователь.",
                    },
                    "reminder_time": {
                        "type": "string",
