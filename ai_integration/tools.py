...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            "name": "add_task",
            "description": "Создать НОВУЮ задачу. ТОЛЬКО по явному согласию пользователя — сначала предложи в тексте, потом создавай. НИКОГДА не придумывай reminder_time — если пользователь не указал время, спроси. Для переноса существующих — edit_task(reminder_time=...).",
            "parameters": {
                "type": "object",
                "properties": {
                    "title": {
