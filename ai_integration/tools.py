...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "🤝 Запустить кампанию делегирования: агент ищет исполнителей и раздаёт задачи. Ключевые слова: раздай задачи, найди тестировщиков, распредели задачи.",
            "parameters": {
                "type": "object",
                "properties": {
                    "name": {
