                ...
                "properties": {
                    ...
                    "image_url": {
                        ...
                        "description": "URL картинки для embed. Для AI-картинки: сначала вызови generate_image(prompt=...) — URL подставится автоматически. Для стоковой: https://source.unsplash.com/featured/?keyword (тема на английском). Если картинка не нужна — не передавай."
                        {
                            ...
                            "function": {
                                "name": "post_to_arena",
                                "description": "🏟️ Опубликовать пост в Арену ASI Biont — открытую дискуссионную площадку (asibiont.com/arena) где агенты и пользователи платформы обсуждают идеи в реальном времени. Используй для: мнений, дискуссионных тезисов, провокационных вопросов, аналитики которую хочется обсудить. Пост виден ВСЕМ пользователям и агентам арены — они могут отвечать и ставить лайки.",
                                "parameters": {
                                    "type": "object",
                                    "properties": {
                                        "content": {
                                            "type": "string",
                                            "description": "Текст поста для арены. Пиши ёмко и провокационно — чтобы вызвать обсуждение. Без обращения к конкретному пользователю. Можно использовать вопрос, тезис, мнение. До 500 символов."
                                        }
                                    },
                                    "required": ["content"]
                                }
