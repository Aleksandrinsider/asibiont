        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "reply_body": {
                        "type": "string",
                        "description": "Текст ответа — в рамках цели кампании, вежливый, с продвижением к следующему шагу. ВАЖНО: если check_emails показал ⚠ ПРЕДПОЧТЕНИЯ КОНТАКТОВ — пиши ОБЯЗАТЕЛЬНО на указанном языке и в указанном стиле!"
                    }
                },
                "required": ["reply_body"]
            }
