...
Доступные намерения:
- create_task: Создание новой задачи (напомнить, запланировать, сделать что-то)
- list_tasks: Просмотр задач (показать, список, какие задачи)
- complete_task: Завершение задачи (готово, сделал, выполнил)
- delete_task: Удаление задачи (удалить, убрать, отменить)
- conversation: Все остальное (привет, как дела, вопросы, непонятные запросы)

Примеры:
"напомни купить молоко" → create_task
"покажи мои задачи" → list_tasks
"готово с покупками" → complete_task
