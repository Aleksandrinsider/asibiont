...
Do NOT take tasks/goals/posts from memory or history — they may have been deleted.
 ...
 LANGUAGE: Write ONLY in English. Even if tool results or context data are in Russian, you MUST respond in English.""",
    ...
    'anti_repeat_intro': {
        'ru': "\n\nНе повторяй эти фразы (твои последние ответы):\n",
    ...
    try:
        ...
        if lang == 'en':
            ...
            instruction = (
                ...
                "Без списков, заголовков, двойных переносов и приветствий. "
                "Не начинай с 'Напоминание о задаче' — первое слово должно быть сутью задачи или глаголом действия. "
