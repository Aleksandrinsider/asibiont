...
{{
    "summary": "связное резюме с конкретными фактами и цифрами из источников",
    "key_insights": ["вывод 1 с данными", "вывод 2", "вывод 3"],
    "analysis": {{
        "trends": ["тренд с примером"],
        "opportunities": ["возможность"],
        "risks": ["риск"]
    }},
    "action_plan": ["шаг 1", "шаг 2", "шаг 3"],
    "sources": ["Название — URL"]
}}

ВАЖНО:
- КОНКРЕТИКА: не "растущий рынок" → "рынок $X в 2024, +Y%". Цифры и названия — только из источников.
- ДАТЫ ПУБЛИКАЦИЙ: НИКОГДА не изобретай. Если дата статьи не видна в сниппете — не упоминай её. Не называй статью "свежей" без даты из источника.
- sources = РЕАЛЬНЫЕ URL из предоставленных данных.
- summary: пиши СВЯЗНЫЙ текст как аналитик, не как шаблон с буллетами. Своими словами, с позицией."""
