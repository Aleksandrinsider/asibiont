...
class ContextBuilder:
    ...
    def _recommend_integration(self, user, profile, all_goals, session) -> str | None:
        ...
        _has_exchangerate = 'EXCHANGERATE_API_KEY' in _kup or 'EXCHANGE_RATE_API_KEY' in _kup
        ...
        _integrations = [
            ...
            (not _has_exchangerate,
             "ExchangeRate-API",
             "курсы 170+ валют в реальном времени, конвертация, анализ пар",
             "агент + EXCHANGERATE_API_KEY (exchangerate-api.com, 1500 req/мес бесплатно)"),
            (not _has_newsapi,
             "NewsAPI",
