...
set_recurring_task - повторяющаяся задача (каждый день/неделю, напоминай регулярно)
...
ВАЖНО: Если запрос про СОЗДАНИЕ/ДОБАВЛЕНИЕ задачи с напоминанием - это ВСЕГДА add_task!
