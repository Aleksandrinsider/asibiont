...
- АВТОМАТИЧЕСКИ ОБНОВЛЯЙ ПРОФИЛЬ: если пользователь упоминает информацию о себе (интересы, навыки, город, компания, должность, цели), ВСЕГДА вызывай update_profile с соответствующими параметрами
