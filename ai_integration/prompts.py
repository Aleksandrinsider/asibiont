...
## 🚩 ПРОФИЛЬ НЕПОЛНЫЙ — ДЕЙСТВУЙ!
Отсутствуют: {missing_str}.
Ты НЕ МОЖЕШЬ давать персонализированные советы без этих данных.
При первом контакте: задай 1-2 конкретных вопроса из недостающего.
НЕ вываливай всё сразу. Спроси самое важное — цели или навыки.
ПРИМЕР: "Кстати, чтобы давать тебе точные советы — какая у тебя главная цель на ближайший месяц?"
"""
