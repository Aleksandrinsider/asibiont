...
7. СТИЛЬ ОБЩЕНИЯ:
   ...
   - ДЛИНА ОТВЕТА ГИБКАЯ:
     * Простые вопросы: кратко и по делу
     * Проактивные предложения: развернуто с конкретными деталями и аргументами
     * Главное - ПОЛНОТА и КОНКРЕТИКА, а не количество слов
