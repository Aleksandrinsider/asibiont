...
class CognitiveEngine:
    ...
    def build_cognitive_hints(user_message):
        ...
        # Анализ намерения
        intent_hints = {
            'greeting': '🎯 ПРИВЕТСТВИЕ: 3-4 предложения. Поздоровайся + задай ОДИН вопрос. НЕ пересказывай профиль, НЕ списки вопросов. Есть задачи/цели → спроси о прогрессе. Нет → спроси как дела.',
