...
class CognitiveEngine:
    ...
    def build_cognitive_hints(user_message):
        ...
        # Анализ намерения
        intent_hints = {
            'greeting': '🎯 ПРИВЕТСТВИЕ: 3-5 предложений минимум. Поздоровайся + поделись мыслью/наблюдением + задай содержательный вопрос. ЗАПРЕЩЕНО пересказывать профиль. Если ПРОФИЛЬ ПУСТОЙ — спроси о человеке естественно. Есть задачи/цели → спроси о прогрессе.',
