...
class CognitiveEngine:
    ...
    def build_cognitive_hints(user_message):
        ...
        # Анализ намерения
        intent_hints = {
            'greeting': '🎯 ПРИВЕТСТВИЕ: Поздоровайся + задай ОДИН живой вопрос. ЗАПРЕЩЕНО пересказывать профиль ("Вижу, что у тебя...", "У тебя интересы в..."). Если ПРОФИЛЬ ПУСТОЙ или есть незаполненные поля — спроси о человеке естественно ("Чем занимаешься?", "Над чем работаешь?"). Есть задачи/цели → спроси о прогрессе.',
