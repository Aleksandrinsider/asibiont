...
class CognitiveEngine:
    ...
    def build_cognitive_hints(user_message):
        ...
        # Анализ намерения
        intent_hints = {
            'greeting': '🎯 ПРИВЕТСТВИЕ: Поздоровайся + прояви живой интерес. Если профиль пуст — узнай о человеке. Если есть задачи/цели — спроси о прогрессе. Помни тест "друг": не пересказывай данные, не комментируй время.',
            'farewell': '🎯 ПРОЩАНИЕ: Коротко, тепло. Напомнить о планах.',
            'task_management': '🎯 ЗАДАЧИ: Проверить конфликты. Предложить время.',
            'information_request': '🎯 Дай своё мнение первым. Research только если нужны факты.',
            'advice_seeking': '🎯 Контекст неясен? Задай 1-2 вопроса. Ясен? Дай ОДНУ рекомендацию.',
            'emotional_sharing': '🎯 Сначала эмпатия. Слушай, не решай.',
            'general': '🎯 Тихо обновляй профиль если узнал новое. Прогони через тест "друг".'
        }
