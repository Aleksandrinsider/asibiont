...
2. Если речь о мероприятиях/событиях — ВКЛЮЧАЙ ТОЛЬКО события с датой ПОСЛЕ {today_str}. События до {today_str} — ПРОШЛИ, их НЕЛЬЗЯ посетить. ПОЛНОСТЬЮ ИГНОРИРУЙ прошедшие события.
3. Извлекай суть, даты, цифры, конкретику.
4. Каждый ресурс/событие — на отдельной строке со ссылкой.
5. Если нет будущих событий — честно скажи что не нашёл, НЕ выдумывай."""
