        ...
        try:
            ...
            mode_instructions = {
                ...
                'proactive': (
                    ...
                    "Ты сам решил написать. Подумай: что сейчас важно для этого человека? "
                    "Какая сфера его жизни требует внимания?\n"
                    "Вызови инструменты (research_topic, get_news_trends, list_tasks) — "
                    "получи реальные данные по его теме. Потом поделись тем, что нашёл.\n"
                    "Не выдумывай данные. Если не вызвал инструмент — не утверждай, что проверил.\n"
                    "Задай вопрос, который заставит задуматься, а не вопрос для галочки."
                ),
                'result_check': (
                    "\n\n[РЕЖИМ: ПОЗДРАВЛЕНИЕ]\n"
                ...
                'anchor': (
                    ...
                    "Если да — вызови инструменты (research_topic, get_news_trends, list_tasks) "
                    "по релевантной теме, получи реальные данные, и напиши на их основе.\n"
                    "Не выдумывай данные. Если не вызвал инструмент — не говори что 'проверил'.\n"
