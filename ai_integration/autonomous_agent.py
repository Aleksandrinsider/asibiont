...
async def _exec_agent_for_director(agent: dict, task: str, user_id: int, dialog_context: str = "", _depth: int = 0) -> tuple:
    ...
    if _is_autopilot_task:
        ...
        system_prompt = (
            ...
            "     • Заголовки-секции: «Что обнаружил:», «Что сделал:», «Дальше думаю так:», «Итог:», «Результат:», «Факты:», «Следующий шаг:» — это анкета, не разговор\n"
        ...
        "шаблоны «Что обнаружил:», «Что сделал:», «Дальше думаю так:», «Итог:», «Результат:», ЦЕЛЕВАЯ АУДИТОРИЯ: — читаются как отчёт, не как мессенджер. Пиши сплошным текстом, заголовки заменяй новым абзацем.\n"
