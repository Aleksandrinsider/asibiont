        ...
        try:
            ...
            try:
                ...
                base_prompt += (
                    ...
                    "\n🕐 ВРЕМЯ ПРИ ПРЕДЛОЖЕНИИ ЗАДАЧ: ГЛАВНОЕ ПРАВИЛО — пользователь пишет СЕЙЧАС = он онлайн и готов. Предлагай ближайшее время через 15-30 минут. НЕ откладывай на завтра! Если пользователь говорит 'сейчас/прямо сейчас' → reminder_time='сейчас'. Только после 01:00 ночи предлагай завтра. ВСЕГДА проверь существующие задачи — не предлагай занятое время."
                )
            except Exception as e:
