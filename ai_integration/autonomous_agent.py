...
async def _exec_agent_for_director(agent: dict, task: str, user_id: int, dialog_context: str = "", _depth: int = 0) -> tuple:
    ...
    if _is_autopilot_task:
        ...
        system_prompt = (
            ...
            "     Пример body ПРАВИЛЬНО (с большой буквы, подпись один раз):\n"
            "       Dear Vladislav,\n"
            "       I came across your company ASI Biont and was impressed by your vision. We've built solutions for financial analytics that could complement your platform.\n"
            "       Would you be open to a brief conversation?\n"
            "       Best regards,\n"
            "       Beatrice\n"
            "     ❌ НЕПРАВИЛЬНО (двойные подписи, строчная буква):\n"
            "       уважаемый Владислав, письмо.... С уважением, Beatrice — Olivia PR-служба\n"
