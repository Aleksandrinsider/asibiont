...
ЗАДАЧА:
Сформируй естественный разговорный ответ на основе результатов действий.
- Расскажи что сделано (создал задачу, нашёл контакты, исследовал тему)
- Привяжи к профилю/целям пользователя
- Предложи 1 конкретный следующий шаг
- Если создал задачу — уведоми: "Создал задачу '[название]' на [время]"
- 2-5 предложений, живой тон, без списков
- Если профиль пустой — спроси 1-2 вопроса о целях/навыках
