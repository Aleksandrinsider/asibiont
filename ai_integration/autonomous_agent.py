        ...
        try:
            ...
            try:
                ...
                base_prompt += (
                    ...
                    "\n⚠️ ЗАДАЧИ БЕЗ ВРЕМЕНИ: Если в списке задач пользователя есть задачи с пометкой '⚠️ БЕЗ ВРЕМЕНИ' — предложи КОНКРЕТНОЕ время (HH:MM): 'У задачи X нет времени — поставить на завтра в 10:00?'. Задача без напоминания = задача которую забудут."
                    "\n🕐 ТОЧНОЕ ВРЕМЯ ПРИ ПРЕДЛОЖЕНИИ ЗАДАЧ: когда предлагаешь задачу или спрашиваешь 'на когда?' — ВСЕГДА предлагай КОНКРЕТНОЕ время HH:MM. Посмотри текущее время в контексте, округли до ближайших :00/:30, добавь 30-60 минут. Если поздний вечер (после 22:00) — предлагай завтра в 10:00. НИКОГДА не пиши 'на завтра утро', 'на вечер', 'на ближайшее время'. Пиши '10:00', '15:30', '09:00'. Также проверь существующие задачи — не предлагай время которое уже занято."
                )
            except Exception as e:
